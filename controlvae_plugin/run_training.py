...
def run_training(run_seed: int, options: RunOptions, num_areas: int) -> None:
    ...
    with hierarchical_timer("run_training.setup"):
        ...
        # Set up shared statics for side channel communication
        shared_statics._MANAGER = mp.Manager()
        shared_statics.STATICS = shared_statics._MANAGER.dict()
        ...
        env_factory = create_environment_factory(
            ...
            shared_statics.STATICS,         #added shared statics because I'm losing my mind
        )
...
def create_environment_factory(
    ...
    log_folder: str,
    shared_dict             #added shared dict for side channel communication
    ...
    def create_unity_environment(
        ...
        # Add the custom side channel to the list of side channels
        statistics_channel = CustomSideChannel(shared_dict=shared_dict)
        side_channels.append(statistics_channel)
...
def main():
    argv = [    
            ...
            "--env=D:/Documents/Unity/Projects/UnityControlVAE1/Build/ControlVAE/UnityControlVAE1.exe",
            "--no-graphics", 
            "--num-envs=6",
            #"--width=900",
            #"--height=600"
    ...
    argv_heading = [    
            "config/high_level/heading/config-heading.yaml", "--resume",
            "--time-scale=1",
            #"--env=D:/Documents/Unity/Projects/UnityControlVAE1/Build/ControlVAEHeading/UnityControlVAE1.exe",
            #"--no-graphics", 
            #"--num-envs=6",
            #"--width=900",
            #"--height=600",
            ]
    run_cli(parse_command_line(argv_heading))
